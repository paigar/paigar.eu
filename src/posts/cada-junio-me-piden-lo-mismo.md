...
image: /img/cada-junio-me-piden-lo-mismo.png
image_alt: "Post-it con franjas en colores del arcoíris colocado encima de una gruesa carpeta corporativa color beige sobre una mesa de madera; única mancha de color en una escena por lo demás neutra y silenciosa, evocando un gesto temporal aplicado sobre un fondo permanente."
---

Cada año, a finales de mayo, me llega el mismo correo. A veces de dos clientes, a veces de tres. El asunto es siempre alguna variante de _"para junio queremos preparar algo"_, y dentro del cuerpo viene el encargo concreto: el logo de la empresa pintado con los colores de la bandera arcoíris, un banner en la cabecera de la home, alguna decoración temporal que comunique que el negocio "se suma al mes del Orgullo".
